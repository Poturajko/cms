...
abstract class BaseAdmin extends BaseController
{
    ...
    protected function inputData()
    {
        if (!MS_MODE) {
            ...
            if (preg_match('/msie|trident.+?rv\s*:/i', $_SERVER['HTTP_USER_AGENT'])) {
                ...
                exit('Вы используете устаревшую версию браузера. Пожалуйста обновитесь до актуальной версиии.');
            }
    ...
    protected function createFiles($id)
    {
        ...
        $this->fileArray = $file_edit->addFile($this->table);
                ...
                if ($targetKey !== false) {
                    ...
                    if (isset($tables['type'])) {
                        ...
                        if ($data) {
                            ...
                            //TODO $this->foreignData[$tables[$otherKey]]['name'] = 'Выбрать';
                            $this->foreignData[$tables[$otherKey]][$tables[$otherKey]]['name'] = 'Выбрать';

                            foreach ($data as $item) {

                                //TODO $this->foreignData[$tables[$otherKey]]['sub'][] = $item;
                                $this->foreignData[$tables[$otherKey]][$tables[$otherKey]]['sub'][] = $item;
